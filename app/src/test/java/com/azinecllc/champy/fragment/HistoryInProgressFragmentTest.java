...
public class HistoryInProgressFragmentTest {

    private View view;
    private HistoryInProgressFragment fragment;
    private HistoryActivity activity;

    @Before
    public void setUp() throws Exception {
        activity = Robolectric.buildActivity(HistoryActivity.class).create().get();
        fragment = new HistoryInProgressFragment();
    ...
    public void testForFragment() throws Exception {
        ...
        assertEquals("HistoryInProgressFragment", fragment.getClass().getSimpleName());
    }
