...
public class HistoryWinsFragmentTest {

    private View view;
    private HistoryWinsFragment fragment;
    private HistoryActivity activity;

    @Before
    public void setUp() throws Exception {
        activity = Robolectric.buildActivity(HistoryActivity.class).create().get();
        fragment = new HistoryWinsFragment();
    ...
    public void testForFragment() throws Exception {
        ...
        assertEquals("HistoryWinsFragment", fragment.getClass().getSimpleName());
    }
