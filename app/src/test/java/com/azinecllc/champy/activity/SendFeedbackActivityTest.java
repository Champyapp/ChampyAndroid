...
public class SendFeedbackActivityTest {
    ...
    public void testForCanonicalActivityPath() throws Exception {
        assertNotNull(activity);
        Assert.assertEquals("com.azinecllc.champy.activity.SendFeedbackActivity",
    ...
    public void testForToolbar() throws Exception {
        ...
        assertEquals("Send Feedback", toolbar.getTitle());
    ...
    public void testForButtonSend() throws Exception {
        ...
        assertEquals(36, lp.leftMargin);
        assertEquals(36, lp.rightMargin);
