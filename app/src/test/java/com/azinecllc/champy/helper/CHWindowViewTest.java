...
public class CHWindowViewTest {
    ...
    public void getWindowWidth() throws Exception {
        ...
        System.out.println("expect: " + CHWindowView.getWindowWidth(context) + " | actual: " + mockDisplay.getWidth()); //mockWM.getDefaultDisplay().getWidth());
    ...
    public void getWindowHeight() throws Exception {
        ...
        // STUB
        WindowManager mockWM = mock(WindowManager.class);
        Display mockDisplay  = mockWM.getDefaultDisplay();
        Point mockScreenSize = mock(Point.class);

        //when(mockDisplay.getSize(mockScreenSize));




        assertEquals(CHWindowView.getWindowHeight(mockContext), 1080);
    }
