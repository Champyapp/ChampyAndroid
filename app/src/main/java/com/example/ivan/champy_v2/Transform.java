...
public class Transform implements Transformation<Bitmap> {
    ...
    public Transform(Context context, int radius, int margin) {
        this(context, radius, margin, CornerType.ALL);
    }

    public Transform(BitmapPool pool, int radius, int margin) {
