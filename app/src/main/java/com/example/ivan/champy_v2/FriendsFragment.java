    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (c.moveToFirst()) {
            ...
            do {
                ...
                friends.add(new com.example.ivan.champy_v2.Friend(c.getString(nameColIndex), API_URL+c.getString(photoColIndex), c.getString(index)));
            } while (c.moveToNext());
        } else
            Log.i("stat", "0 rows");
        c.close();
                        ...
                        if (response.isSuccess()) {
                            ...
                            if (c.moveToFirst()) {
                                ...
                                do {
                                    ...
                                    newfriends.add(new Friend(c.getString(nameColIndex), API_URL+c.getString(photoColIndex), c.getString(index)));
                                } while (c.moveToNext());
                            } else
                                Log.i("stat", "0 rows");
                            c.close();
