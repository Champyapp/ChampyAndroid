...
import com.example.ivan.champy_v2.data.FakeDataProvider;
import com.example.ivan.champy_v2.model.Article;
import com.example.ivan.champy_v2.view.ArticleAdapter;
...
public class TestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layoutManager = new AwesomeLayoutManager(getApplicationContext());
